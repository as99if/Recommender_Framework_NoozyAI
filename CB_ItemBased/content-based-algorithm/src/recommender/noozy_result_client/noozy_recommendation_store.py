"""
Formats and stores recommendation in by 'user_id' in a json log file
and in redis4engine with 'noozy_result_redis_client.py'
...
class Store:
    ...
    def log_store(self) -> bool:
        ...
        try:
            ...
            print("saved result " + store_filename)
            return True
        except KeyError:
            return False
